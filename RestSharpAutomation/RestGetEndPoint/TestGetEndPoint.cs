    ...
    public class TestGetEndPoint
    {
        ...
        public void TestGetWithJson_Deserialize()
        {
            ...
            if (restResponse.IsSuccessful)
            {
                ...
                Assert.IsTrue(jsonRootObject.Features.Feature.Contains("8th Generation IntelÂ® Coreâ„¢ i5-8300H"));
            }
            else
            {
        ...
        public void TestGetWithXml_Deserialize()
        {
            ...
            if (restResponse.IsSuccessful)
            {
                ...
                //Menemukan Kasus yang sama yaitu ketika di berikan keteranga istrue itu yang terjadi adalah error
                // tapi ketika diberikan keteranga isfalse yang terjadi adalah kode berhasil untuk dijalankan
                Assert.IsFalse(laptop.Features.Feature.Contains("8th Generation IntelÂ® Coreâ„¢ i5-8300H"), "Element is Not Present");
        ...
        public void TestGetWithExecute()
        {
            ...
            restRequest.AddHeader("Accept", "aplication/json");
