...
namespace RestSharpAutomation.RestPutEndPoint
{
    ...
    public class TestPutEndPoint
    {
        ...
        public void TestPutWithJsonData()
        {
            ...
            Assert.IsTrue(restResponse1.Data.Features.Feature.Contains("New Feature"), "Feature did not got update ");
        ...
        public void TestPutWithXmlData()
        {
            ...
            RestClientHelper restClientHelper = new RestClientHelper();
            IRestResponse restResponse = restClientHelper.PerformPostRequest(postUrl, headers, xmlData,
            ...
            var deserialize = new RestSharp.Deserializers.DotNetXmlDeserializer();

            var laptop = deserialize.Deserialize<Laptop>(restResponse1);
            Assert.IsTrue(laptop.Features.Feature.Contains("Update Feature"), "Feature did not got Update");
            ...
            Assert.IsTrue(restResponse2.Data.Features.Feature.Contains("New Feature"), "Feature did not got update ");
        }
        [TestMethod]
        public void TestPutWithXmlData_HelperClass()
        {
            ...
            Assert.IsTrue(restResponse3.Data.Features.Feature.Contains("Update Feature"), "Feature did not got Update");
