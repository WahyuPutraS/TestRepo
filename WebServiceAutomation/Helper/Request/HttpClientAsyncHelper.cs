...
namespace WebServiceAutomation.Helper.Request
{
    public class HttpClientAsyncHelper
    {
        ...
        //}
        //private RestResponse SendRequest(string requestUrl, HttpMethod httpMethod, HttpContent httpContent,
        ...
        public async Task<RestResponse> PerformPostRequest(string requestUrl, HttpContent
            httpContent, Dictionary<string, string> httpHeader)
        {
            httpClient = AddHeadersAndCreateHttpClient(httpHeader);
        ...
        public async Task<RestResponse> PerformPutRequest(string requestUrl, string content, string
            mediaType, Dictionary<string, string> httpHeader)
        {
