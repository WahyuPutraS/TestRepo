...
namespace WebServiceAutomation.Helper.Request
{
    public class HttpClientHelper
    {
        ...
        public static RestResponse PerformPostRequest(string requestUrl,HttpContent
            httpContent,Dictionary<string, string> httpHeaders)
        {
        ...
        public static RestResponse PerformPutRequest(string requestUrl, string content, string 
            mediaType, Dictionary<string,string> headers)
        {
